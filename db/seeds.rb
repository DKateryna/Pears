...
Pair.create!(user: user1, matched_id: user3.id)
Pair.create!(user: user1, matched_id: user4.id)
Pair.create!(user: user1, matched_id: user5.id)
Pair.create!(user: user3, matched_id: user6.id)
Pair.create!(user: user3, matched_id: user2.id)
Pair.create!(user: user3, matched_id: user4.id)
Pair.create!(user: user3, matched_id: user5.id)
Pair.create!(user: user7, matched_id: user6.id)
Pair.create!(user: user4, matched_id: user2.id)
Pair.create!(user: user4, matched_id: user3.id)
Pair.create!(user: user4, matched_id: user5.id)
Pair.create!(user: user5, matched_id: user2.id)
Pair.create!(user: user5, matched_id: user3.id)
Pair.create!(user: user6, matched_id: user5.id)
Pair.create!(user: user4, matched_id: user5.id)
Pair.create!(user: user6, matched_id: user2.id)
Pair.create!(user: user6, matched_id: user3.id)
Pair.create!(user: user6, matched_id: user5.id)
